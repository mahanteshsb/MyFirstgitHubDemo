...
import com.socinator.qa.util.DeleteFilesInDirectory;
import com.socinator.qa.util.Helpers;
import com.socinator.qa.util.ReadConfig;
import com.socinator.qa.util.Screenshot;
...
//	public static LoginPage loginPage;
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/socinator" + "/qa/config/config.properties");
			prop.load(ip);
